...
CALL %RSVARS%
SET PATH=%PATH%
SET SEARCH_PATH="%JENKINS_HOME%\jobs\Prueba Compilacion Libreria\workspace\Librerias\Output;%JENKINS_HOME%\jobs\Prueba Tests Unitarios\workspace\TestsUnitarios\Output"
